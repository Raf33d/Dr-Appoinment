        ...
        {appointments.map((item, index) => (
          <div className='grid gird-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              {item.cancelled && !item.isCompleted && <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded bg-red-600 text-white cursor-not-allowed'>Appointment Cancelled</button>}
